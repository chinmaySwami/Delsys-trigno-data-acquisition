...
#     sim.step()
#     if step < 5000:
#         sim.data.ctrl[5:7] = [0.08, 0]
#     else:
#         sim.data.ctrl[5:7] = [0, 0]
#     step += 1
#     print(sim.data.ctrl)
...
import pytest
import random
from mujoco_py import (MjSim, load_model_from_xml, cymj, load_model_from_path)
...
def test_mj_pid():
    ...
    model = load_model_from_path("pid_test.xml")
    sim = MjSim(model)
